...
<head>
    ...
    <title>Company's Login</title>
    <link rel="stylesheet" href="{{ asset('Company/index.css') }}">
...
@endif
                        <form style="width: 23rem;" method="post" action="{{ url('submit')}}">
                            ...
                            <p class="small mb-5 pb-lg-2"><a class="text-muted" href="{{ url('forget/Password') }}">Forgot password?</a></p>
